...
impl XyRect {
    pub fn new(x: Range<f64>, y: Range<f64>, z: f64, material: Arc<dyn Material>) -> Self {
        Self { x, y, z, material }
    }
}

impl XzRect {
    pub fn new(x: Range<f64>, y: f64, z: Range<f64>, material: Arc<dyn Material>) -> Self {
        Self { x, y, z, material }
    }
}

impl YzRect {
    pub fn new(x: f64, y: Range<f64>, z: Range<f64>, material: Arc<dyn Material>) -> Self {
        Self { x, y, z, material }
    }
}
...
impl Hittable for XyRect {
    ...
    fn bounding_box(&self, _time: &Range<f64>) -> Option<AABB> {
        Some(AABB::new(
